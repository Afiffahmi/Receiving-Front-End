...
export default function OrderTable() {
  ...
  const handleUpdate = async () => {
    ...
    setTimeout(() => {
      navigate('/receiving', { replace: true, state: { supplier: data.Supplier,date:data.Date } } )
    }, 8000);
  }else{
      ...
      <Transition in={open} timeout={400}>
        {(state: string) => (
          ...
          >
            ...
            >
              <DialogTitle><Typography level="h2">Receiving Information</Typography></DialogTitle>
              <DialogContent>
              <Stepper
      size="lg"
      sx={{
    ...
    <Sheet
          ...
          >
            ...
            <div>
              ...
              <Typography fontWeight="lg">{data.Description}</Typography>
            </div>
          </Sheet>
