  ...
  return (
    <React.Fragment>
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <ModalDialog>
          <DialogTitle>Update order detail</DialogTitle>
          <DialogContent>Fill in the information of the order.</DialogContent>
          <Stack gap={4} sx={{ mt: 2 }}>
              <form
              ...
              >
                ...
                <FormControl required>
                  <FormLabel>Quantity (remaining quantity)</FormLabel>
